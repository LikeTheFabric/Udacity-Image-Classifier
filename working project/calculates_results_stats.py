...
def calculates_results_stats(results_dic):
    ...
    #sets all counter to 0 so that they will increment while processing through the images
    ...
    for key in results_dic:
       ...
       #pet image labe is a dog, counts number of dog images 
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
                      
            #Image correctly classified as a dog counts number of correct dog classifications
            if results_dic[key][4] == 1: 
                results_stats_dic['n_correct_dogs'] += 1
            
        else: 
            #classifier classifies image as not a dog and counts number of correct not dog classifications
   ...
   #Calculates total number of images
    ...
    #percentage of not-a-dog images
